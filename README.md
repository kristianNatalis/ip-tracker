...
Proyek ini sebagian besar dibangun dan didebug dengan bantuan kecerdasan buatan (AI). 
AI digunakan untuk:
* Mendelegasikan pembuatan komponen GUI (User Interface).
* Menyusun logika penanganan API tracking IP.
* Membantu proses *refactoring* dan penyusunan struktur file.

*This project is heavily assisted and generated by AI for educational and prototyping purposes.*
